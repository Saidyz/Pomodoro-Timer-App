...
def count_down(count):
    ...
    if count>0:
        ...
        for _ in range(work_sesions):
            marks += "✓"
        chekmark_lable.config(text=marks)
...
chekmark_lable = Label( fg=GREEN,highlightthickness=0,bg=YELLOW, font=(FONT_NAME,12, "bold"))
chekmark_lable.grid(column=1, row=3)
